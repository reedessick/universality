...
DEFAULT_INTERPOLATOR_RTOL = 1e-3
...
def stellar_sequence(
    ...
    pressurec2, energy_densityc2 = eos
...
def bisection_stellar_sequence(
    ...
    if np.all(np.abs(errors) < integration_rtol*mid_pc2_macro): ### interpolation is "good enough"
        ...
        return left_pc2 + right_pc2[1:], left_macro + right_macrio[1:] ### avoid returning repeated models
